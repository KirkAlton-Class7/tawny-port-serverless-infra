# Tawny Port - HTTP API Console Runbook

## Purpose

Build the Tawny Port HTTP API deployment in the AWS Console, then validate the browser user experience through Cognito Managed Login.
